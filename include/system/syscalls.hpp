...
namespace linux {
    namespace syscall {
         ...
         *
         * This function wraps the mmap system call, which maps a region of
         * memory into the address space of the calling process.
         *
         * @param address The starting address for the mapping. If set to 0,
         ...
         * (e.g., shared, private).
         * @param fileDescriptor The file descriptor of the file to map,
         * or -1 for anonymous mapping.
         ...
         * @brief Structure for passing arguments to the mmap system call
         * (32-bit version).
         *
         * This structure encapsulates the parameters required for the mmap
         * system call
         * on 32-bit systems.
         */
        typedef struct {
         ...
         * This function wraps the mmap system call, which maps a region of
         * memory into the address space of the calling process.
         * On 32-bit systems, the parameters are passed as a pointer to a
         * mmap_arg_struct.
         *
         * @param arguments A pointer to a mmap_arg_struct containing the
         ...
         *
         * This function wraps the munmap system call, which unmaps a
         * previously mapped region of memory.
         *
